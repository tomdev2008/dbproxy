...
public:
	void ObtainRespHead(const MessageHeadSS* reqHead, MessageHeadSS& respHead, const uint32_t nMsgID);
//	void    SendOfficialMail(RoleID nRoleID, const char* szMsg, int32_t nClientID);
	...
	*/
	...
	CMysqlEngine& GetMysqlReadEngine();
private:
...
#define MYSQLREADENGINE   g_BllBase.GetMysqlReadEngine()
